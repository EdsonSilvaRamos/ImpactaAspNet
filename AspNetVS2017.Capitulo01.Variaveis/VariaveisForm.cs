...
namespace AspNetVS2017.Capitulo01.Variaveis
{
    public partial class VariaveisForm : Form
    {
        ...
        private void aritimeticasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            // string nome = "Edson";
            // bool aprovado = true;
            // DateTime dataNascimento = new DateTime(1987, 11, 06);
            // int f = 17;
            // var, após o sinal de igualdade ele infere qual é o tipo
            // E só pode utilizar quando ele tem um valor atribuido
            //var sobrenome = "Ramos";
            // var @decimal = 0.2m;
            //object meuObjeto = 45;
            //meuObjeto = "Edson";
